...
public class AIPImpl implements ArchivalInformationPackage {
	...
	public static class RepositoryPlacement {
		public String parentPath;
		public PID pid;

		/**
		 * An explicit position number for this object within the parent's other children, designated by the submitter.
		 * May be NULL.
		 */
